...
def clean_card_table(save_changes=False):
    ...
    card_df['card_issued_date'] = card_df['issued'].map(convert_date_to_days)  # change card_issued_date type to int64
    del card_df['issued']
    ...
    if save_changes:  # if specified, saves the changes made
        card_df.to_csv(f"{data_directory}/card.csv")
...
def clean_client_table(save_changes=False):
    ...
    if save_changes:  # if specified, saves the changes made
        client_df.to_csv(f"{data_directory}/client.csv")
...
def clean_account_table(save_changes=False):
    ...
    account_df['account_date_opened'] = account_df['date'].map(convert_date_to_days)  # create another field
    ...
    if save_changes:  # if specified, saves the changes made
        account_df.to_csv(f"{data_directory}/account.csv")
...
def clean_disp_table(save_changes=False):
    ...
    if save_changes:  # if specified, saves the changes made
        disp_df.to_csv(f"{data_directory}/disp.csv")
...
def clean_district_table(save_changes=False):
    ...
    if save_changes:  # if specified, saves the changes made
        district_df.to_csv(f"{data_directory}/district.csv")
...
def clean_loan_table(save_changes=False):
    ...
    if save_changes:  # if specified, saves the changes made
        loan_df.to_csv(f"{data_directory}/loan.csv")
...
def clean_order_table(save_changes=False):
    ...
    if save_changes:  # if specified, saves the changes made
        order_df.to_csv(f"{data_directory}/order.csv")
...
def clean_transaction_table(save_changes=False):
    ...
    if save_changes:  # if specified, saves the changes made
        trans_df.to_csv(f"{data_directory}/trans.csv")
