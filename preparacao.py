...
print(card_df.head())
print(card_df['card_type'].value_counts()) #types of card
#------------------------------------------------------------
#           Clean client table
...
print(client_df.head())
print(client_df['client_gender'].value_counts()) #number of client by gender
print(client_df.query('client_age < 18').head()) #underage clients
#------------------------------------------------------------
#           Clean account table
